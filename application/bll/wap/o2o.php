...
class O2o extends wap
{
    ...
    public function orderInit_new($params)
    {
        ...
        // $this->ci->bll_o2ocart->setCart($cart_items);
    ...
    public function createOrder_new($params)
    {
        ...
        $source = $params['source'];
        $version = $params['version'];
        $this->ci->load->bll('o2o',array('source'=>$source,'version'=>$version, 'region_id' => $params['region_id'], 'platform' => $params['platform'], 'version_number' => $params['version_number'], 'device_id' => $params['device_id'], 'android_id' => $params['android_id']));
    ...
    public function getHomePageInfo($params)
    {
        ...
        if(version_compare($version, '4.1.0') >= 0){
            return $this->ci->bll_o2o->getHomePageInfo_v2($region_id,$store_id,$params['lonlatForO2O']);
        }
    ...
    public function getHomePageDetail($params)
    {
        ...
        if(version_compare($version, '4.1.0') < 0){
            ...
            return $this->ci->bll_o2o->getHomePageDetail_v2($region_id,$store_id);
        }
    }
    ...
    public function getProductType($params)
    {
        ...
        $this->ci->load->bll('o2o');
        $result = $this->ci->bll_o2o->getProductType($params['store_id']);
        return $result;
    }
}
