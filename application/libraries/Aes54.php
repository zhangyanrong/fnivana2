...
class Aes54
{
    ...
    */
    public static function AesEncrypt($plaintext,$key = null)
    {
        ...
        $key = is_null($key) ? base64_decode('ASbPyjQPhI9nn2IwC2yEhhhN3XJ1xkMzhsGd54UwmKQ=') : $key;
...
public static function data_hash($data)
{
    // $hashData = bin2hex(mhash(MHASH_SHA256,trim($data) . HASH256_KEY));
    $hashData = hash('sha256',trim($data) . '12345678910111213fruitday');
    return $hashData;
}
}